...
package org.barcelonamedia.uima.tools.docanalyzer;
...
public class DBPrefsMediator {
  ...
  /** Flag which indicates whether XMI are to be uncompressed or not */
  private boolean umcompress;
  ...
  public XMIDAO getXmiDAO(){
		
	  return xmiDAO;
  }

  public void setXmiDAO(XMIDAO xmiDAO){
	
	  this.xmiDAO = xmiDAO;
  }

  public boolean isUmcompress() {
	
	  return umcompress;
  }

  public void setUmcompress(boolean umcompress) {
	  
	  this.umcompress = umcompress;
  }
