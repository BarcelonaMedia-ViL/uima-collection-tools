...
public class DBCollectionReader extends CollectionReader_ImplBase{
	 ...
	 **/
	public static final String PARAM_DBMS = "DBMS";
	...
	/** Correponds to a parameter that specifies the password of the specified database.
	 ...
	 * @see "/DBCollectionReader/desc/DBCollectionReader"
	 **/
	public static final String PARAM_SQL = "sql_select";
